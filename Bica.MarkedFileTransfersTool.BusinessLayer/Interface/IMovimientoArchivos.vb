...
Public Interface IMovimientoArchivos
    ...
    Function ObtenerArchivosRecibidos(fecha As Date, IdProcesos() As Long) As List(Of Model.Procesos_MovimientoArchivos)
    ...
    Function ActualizarRegistroMovimientoArchivo(IdMovimientoArchivo As Long, Transferred As Boolean, DoBackup As Boolean, ToBeTransfer As Boolean, Copied As Boolean, Recibed As Boolean, UserName As String) As Boolean
    ...
    Function ActualizarRegistroRecibido(IdMovimientoArchivo As Long, UserName As String) As Boolean
End Interface
